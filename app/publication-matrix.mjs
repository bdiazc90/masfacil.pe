...
export const FIELD_PUBLICATION_MATRIX = Object.freeze([
  ...
  Object.freeze({
    ...
    permission: 'publicación aprobada explícitamente por el owner para el contrato público downstream; el contrato privado Gate 1.1 conserva su clasificación histórica sin propagarse',
    verdict: 'publishable',
    evidence: 'Decisión autoritativa del owner para Gate 4.1; docs/datos.md § Registro, GIS y geografía conserva procedencia y atribución.',
  }),
  Object.freeze({
    ...
    permission: 'derivada localmente de coordenadas cuya publicación fue aprobada explícitamente por el owner',
    verdict: 'publishable',
    evidence: 'Decisión autoritativa del owner para Gate 4.1; el navegador recalcula Haversine sin datos adicionales.',
  }),
  Object.freeze({
    field: 'razon_social',
