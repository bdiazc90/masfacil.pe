...
| La tarjeta de Diésel lleva un solo precio con su nombre preciso (`B5 S-50 UV`, «Diésel B5 S-50 UV» para lectores) y «por galón» junto a la cifra; la de GLP, igual (`GLP`, «GLP automotor» para lectores); la de Gasolina no cambia | fuera de Gasolina la unidad no se da por supuesta; el nombre del CSV distingue esta variedad de las otras que el mismo grifo reporta, y en GLP del mismo gas en kilogramos o en cilindros |
