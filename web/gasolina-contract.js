...
const identity = (value, conConfianza) => value === null || (same(value, conConfianza ? ['brand', 'public_site_name', 'confidence'] : ['brand', 'public_site_name']) && (value.brand === null || text(value.brand)) && (value.public_site_name === null || text(value.public_site_name)) && (value.brand !== null || value.public_site_name !== null) && (!conConfianza || CONFIDENCE_LEVELS.includes(value.confidence)));
