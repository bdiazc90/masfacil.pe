#!/usr/bin/env node
//   npm run rollback -- <snapshot-id> [<revision-id>] [--group gasolina|diesel]
//
...
if (!snapshotId || !grupo) throw new Error('Uso: npm run rollback -- <snapshot-id> [<revision-id>] [--group gasolina|diesel]');
