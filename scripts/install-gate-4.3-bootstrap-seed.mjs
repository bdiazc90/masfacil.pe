...
if (!target || target.startsWith('-')) throw new Error('Uso: node scripts/install-gate-4.3-bootstrap-seed.mjs --target <directorio-privado>');
...
const payload = decodeSeed(process.env.GATE_4_3_BOOTSTRAP_SEED_B64, manifest);
